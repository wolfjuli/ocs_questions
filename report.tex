...
\end{figure}	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item \question{Discuss the optimality conditions for a quadratic optimization problem of the form
    \(\frac{1}{2} \min_x x'Qx - b'x\).  When is this problem convex and what does convexity imply?
    Give a simple example in 2D showing different realizations of Q.}
  \begin{itemize}
