...
% Of special interest are the classes \(\Lipl\) of convex functions with Lipschitz-continuous gradient
% and \(\strongm\) of \(\mu\)-strongly convex functions. There are a couple of remarkable symmetries
% between properties of them.

% A convex and twice differentiable function is Lipschitz continuous if
% \begin{equation*}
%   \nabla^2 f(x) \preceq L,
% \end{equation*}
% % where
