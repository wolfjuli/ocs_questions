...
\end{equation*}
For constrained minima, we require additionally that \(x \in X\).
...
\end{equation*}
Since wlog. we can choose \(\Delta x\) to have also opposite sign, it holds also that
\begin{equation*}
