...
\(y_i\), and targets and \(z_i\).  Thus, we can see each \(g_i\) as a data block (or minibatch, in
terms of machine learning terminology), and \(g = (g_1, \ldots, g_m)\) as the data set (or whole
batch, resp. epoch).
