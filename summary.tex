...
\summary{Basic Idea}\label{gradient_methods}
...
\summary{Descent Lemma} Let \(f: \RR^n \to \RR\) be Lipschitz continuous with Lipschitz constant
...
\summary{Interpretation of Descent Lemma}
...
Derivation: by Lipschitz continuity we have
\begin{align*}
